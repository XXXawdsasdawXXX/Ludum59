...
namespace MPUIKIT {
    ...
    public class MPImage : Image {
        ...
        public const string MpShaderName = "MPUI/Procedural Sprite";

        #endregion

        #region SerializedFields

        [SerializeField] private DrawShape m_DrawShape = DrawShape.Rectangle;
        ...
        public Material CreateMaterialAssetFromComponentSettings() {
            ...
            AssetDatabase.CreateAsset(matAsset, AssetDatabase.GenerateUniqueAssetPath("Assets/MPImageMat.mat"));
