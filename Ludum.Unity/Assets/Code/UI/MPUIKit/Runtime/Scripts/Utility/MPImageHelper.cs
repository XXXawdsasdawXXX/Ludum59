...
namespace Code.UI.MPUIKit.Runtime.Scripts.Utility {
    public static class MPImageHelper {
        ...
        public static void GenerateSimpleSprite(VertexHelper vh, bool preserveAspect, Canvas canvas,
            ...
            vh.AddVert(pos[0], color32, uvs[0], uvs[0], size, Vector2.zero, Vector3.zero, Vector4.zero);
            vh.AddVert(pos[1], color32, uvs[1], uvs[1], size, Vector2.zero, Vector3.zero, Vector4.zero);
            vh.AddVert(pos[2], color32, uvs[2], uvs[2], size, Vector2.zero, Vector3.zero, Vector4.zero);
            vh.AddVert(pos[3], color32, uvs[3], uvs[3], size, Vector2.zero, Vector3.zero, Vector4.zero);
