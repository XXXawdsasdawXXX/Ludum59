...
namespace Code.UI.MPUIKit.Editor.Scripts
{
    ...
    public class MPUIKitSetupWindow : EditorWindow
    {
        ...
        private const string Version = "Version: 0.96 (Beta)";
        ...
        private static void HandleOnStartup()
        {
            ...
            {
                Debug.LogWarning(
                    "MPUIKit is not setup in the project. Go to 'Window/MPUIKit/Utility Panel' to set it up.");
            }
        ...
        private static bool IsShaderAdded(string shaderName)
        {
            ...
            if (shader == null)
            {
                Debug.LogError($"Could not find the shader '{shaderName}' in project!");
                return false;
            }
        ...
        private void OnGUI()
        {
            ...
            if (GUI.Button(new Rect(buttonRect.width / 2 - 100, buttonRect.y + buttonRect.height / 2 - 20, 200, 45),
                    "Setup MPUIKit"))
            {
            ...
            EditorGUILayout.BeginVertical();
            {
                ...
                EditorGUILayout.BeginHorizontal();
                {
                    ...
                    GUILayout.FlexibleSpace();
                    EditorGUILayout.LabelField(Version, style, GUILayout.Width(120));
                }
